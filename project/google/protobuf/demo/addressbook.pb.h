...
class Addressbook final :
 ...
 public:
  ...
  // repeated .tutorial.Person xixi = 2;
  int xixi_size() const;
  private:
  int _internal_xixi_size() const;
  public:
  void clear_xixi();
  ::tutorial::Person* mutable_xixi(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person >*
      mutable_xixi();
  private:
  const ::tutorial::Person& _internal_xixi(int index) const;
  ::tutorial::Person* _internal_add_xixi();
  public:
  const ::tutorial::Person& xixi(int index) const;
  ::tutorial::Person* add_xixi();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person >&
      xixi() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person > xixi_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_addressbook_2eproto;
...
// repeated .tutorial.Person xixi = 2;
inline int Addressbook::_internal_xixi_size() const {
  return _impl_.xixi_.size();
}
inline int Addressbook::xixi_size() const {
  return _internal_xixi_size();
}
inline void Addressbook::clear_xixi() {
  _impl_.xixi_.Clear();
}
inline ::tutorial::Person* Addressbook::mutable_xixi(int index) {
  // @@protoc_insertion_point(field_mutable:tutorial.Addressbook.xixi)
  return _impl_.xixi_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person >*
Addressbook::mutable_xixi() {
  // @@protoc_insertion_point(field_mutable_list:tutorial.Addressbook.xixi)
  return &_impl_.xixi_;
}
inline const ::tutorial::Person& Addressbook::_internal_xixi(int index) const {
  return _impl_.xixi_.Get(index);
}
inline const ::tutorial::Person& Addressbook::xixi(int index) const {
  // @@protoc_insertion_point(field_get:tutorial.Addressbook.xixi)
  return _internal_xixi(index);
}
inline ::tutorial::Person* Addressbook::_internal_add_xixi() {
  return _impl_.xixi_.Add();
}
inline ::tutorial::Person* Addressbook::add_xixi() {
  ::tutorial::Person* _add = _internal_add_xixi();
  // @@protoc_insertion_point(field_add:tutorial.Addressbook.xixi)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person >&
Addressbook::xixi() const {
  // @@protoc_insertion_point(field_list:tutorial.Addressbook.xixi)
  return _impl_.xixi_;
}
