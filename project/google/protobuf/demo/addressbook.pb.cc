...
const uint32_t TableStruct_addressbook_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tutorial::Addressbook, _impl_.xixi_),
};
...
const char descriptor_table_protodef_addressbook_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "(\0132\020.tutorial.Person\022\036\n\004xixi\030\002 \003(\0132\020.tut"
  "orial.Person"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_addressbook_2eproto = {
    false, false, 332, descriptor_table_protodef_addressbook_2eproto,
    "addressbook.proto",
...
Addressbook::Addressbook(const Addressbook& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.xixi_){from._impl_.xixi_}
    , /*decltype(_impl_._cached_size_)*/{}};
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_xixi(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* Addressbook::_InternalSerialize(
  ...
  // repeated .tutorial.Person xixi = 2;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_xixi_size()); i < n; i++) {
    const auto& repfield = this->_internal_xixi(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:tutorial.Addressbook)
  ...
  // repeated .tutorial.Person xixi = 2;
  total_size += 1UL * this->_internal_xixi_size();
  for (const auto& msg : this->_impl_.xixi_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void Addressbook::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.xixi_.MergeFrom(from._impl_.xixi_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
bool Addressbook::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(_impl_.people_))
    return false;
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(_impl_.xixi_))
    return false;
  return true;
}
...
void Addressbook::InternalSwap(Addressbook* other) {
  ...
  _impl_.xixi_.InternalSwap(&other->_impl_.xixi_);
}
